...
type GetVideoRequest struct {
	...
	CategoryPid     int64 `protobuf:"varint,3,opt,name=categoryPid,proto3" json:"categoryPid,omitempty"`         //大分类id
	CategoryChildId int64 `protobuf:"varint,4,opt,name=categoryChildId,proto3" json:"categoryChildId,omitempty"` //子分类id
}
...
func (x *GetVideoRequest) GetPageIndex() int64 {
	if x != nil {
		return x.PageIndex
	}
	return 0
...
func (x *GetVideoRequest) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *GetVideoRequest) GetCategoryPid() int64 {
	if x != nil {
		return x.CategoryPid
	}
	return 0
...
func (x *GetVideoRequest) GetCategoryChildId() int64 {
	if x != nil {
		return x.CategoryChildId
	}
	return 0
...
type GetVideoResponse struct {
	...
	Code       int64         `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	Message    string        `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`       //"消息"`
	Data       []*MovieModel `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`             //"视频数据"`
	BannerList []*MovieModel `protobuf:"bytes,4,rep,name=bannerList,proto3" json:"bannerList,omitempty"` //banner 数据,只有第一页才会有数据
	Total      int64         `protobuf:"varint,5,opt,name=total,proto3" json:"total,omitempty"`          //总条数
}
...
func (x *GetVideoResponse) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *GetVideoResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *GetVideoResponse) GetData() []*MovieModel {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *GetVideoResponse) GetBannerList() []*MovieModel {
	if x != nil {
		return x.BannerList
	}
	return nil
...
func (x *GetVideoResponse) GetTotal() int64 {
	if x != nil {
		return x.Total
	}
	return 0
...
type GetVideoHotRequest struct {
	...
	CategoryPid int64 `protobuf:"varint,1,opt,name=categoryPid,proto3" json:"categoryPid,omitempty"` //大分类id
	TabType     int64 `protobuf:"varint,2,opt,name=tabType,proto3" json:"tabType,omitempty"`         //0:天热播  1:周热播  2:月热播  3:年热播
}

func (x *GetVideoHotRequest) Reset() {
	*x = GetVideoHotRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetVideoHotRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetVideoHotRequest) ProtoMessage() {}

func (x *GetVideoHotRequest) ProtoReflect() protoreflect.Message {
	mi := &file_server_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetVideoHotRequest.ProtoReflect.Descriptor instead.
func (*GetVideoHotRequest) Descriptor() ([]byte, []int) {
	return file_server_proto_rawDescGZIP(), []int{12}
}

func (x *GetVideoHotRequest) GetCategoryPid() int64 {
	if x != nil {
		return x.CategoryPid
	}
	return 0
...
func (x *GetVideoHotRequest) GetTabType() int64 {
	if x != nil {
		return x.TabType
	}
	return 0
...
func (x *GetVideoHotResponse) Reset() {
	*x = GetVideoHotResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetVideoHotResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetVideoHotResponse) ProtoMessage() {}

func (x *GetVideoHotResponse) ProtoReflect() protoreflect.Message {
	mi := &file_server_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetVideoHotResponse.ProtoReflect.Descriptor instead.
func (*GetVideoHotResponse) Descriptor() ([]byte, []int) {
	return file_server_proto_rawDescGZIP(), []int{13}
}

func (x *GetVideoHotResponse) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *GetVideoHotResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *GetVideoHotResponse) GetData() []*MovieModel {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_server_proto_rawDesc = []byte{
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x97, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x56, 0x69, 0x64,
	0x65, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x70, 0x61, 0x67,
	...
	0x69, 0x7a, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x50,
	0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x79, 0x50, 0x69, 0x64, 0x12, 0x28, 0x0a, 0x0f, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72,
	0x79, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x49, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0f,
	0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x49, 0x64, 0x22,
	0xb2, 0x01, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52, 0x65, 0x73, 0x70,
	...
	,
	...
	,
...
var file_server_proto_goTypes = []any{
	...
	(*GetVideoRequest)(nil),       // 10: server.GetVideoRequest
	(*GetVideoResponse)(nil),      // 11: server.GetVideoResponse
	(*GetVideoHotRequest)(nil),    // 12: server.GetVideoHotRequest
	(*GetVideoHotResponse)(nil),   // 13: server.GetVideoHotResponse
}
var file_server_proto_depIdxs = []int32{
	...
	3,  // 6: server.GetVideoResponse.data:type_name -> server.MovieModel
	3,  // 7: server.GetVideoResponse.bannerList:type_name -> server.MovieModel
	3,  // 8: server.GetVideoHotResponse.data:type_name -> server.MovieModel
	1,  // 9: server.MoviesServer.GetNavigation:input_type -> server.GetNavigationRequest
	5,  // 10: server.MoviesServer.GetRecommend:input_type -> server.GetRecommendRequest
	8,  // 11: server.MoviesServer.GetPlayLine:input_type -> server.GetPlayLineRequest
	10, // 12: server.MoviesServer.GetVideoList:input_type -> server.GetVideoRequest
	12, // 13: server.MoviesServer.GetVideoHotList:input_type -> server.GetVideoHotRequest
	2,  // 14: server.MoviesServer.GetNavigation:output_type -> server.GetNavigationResponse
	6,  // 15: server.MoviesServer.GetRecommend:output_type -> server.GetRecommendResponse
	9,  // 16: server.MoviesServer.GetPlayLine:output_type -> server.GetPlayLineResponse
	11, // 17: server.MoviesServer.GetVideoList:output_type -> server.GetVideoResponse
	13, // 18: server.MoviesServer.GetVideoHotList:output_type -> server.GetVideoHotResponse
...
func file_server_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_server_proto_msgTypes[12].Exporter = func(v any, i int) any {
			switch v := v.(*GetVideoHotRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_server_proto_msgTypes[13].Exporter = func(v any, i int) any {
			switch v := v.(*GetVideoHotResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
